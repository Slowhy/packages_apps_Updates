...
public final class Constants {
    ...
    static final String OTA_URL = "https://ota.cat.wf/%s.json";
    static final String OTA_CI_URL = "";
    static final String MAINTAINER_URL = "https://github.com/Slowhy";
    static final String DOWNLOAD_WEBPAGE_URL = "https://ota.cat.wf/%s_changelog.txt";
